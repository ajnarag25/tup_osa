...
<head>
    <title>TUPC OSA Services - Change Password</title>
    <!-- META TAGS -->
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="head-2-inn head-2-inn-padd-top">
                    <form class="s12" action="process.php" method="POST">
                        ...
                        <input type="password" name="newpass1" class="validate" style="width:50%" placeholder="Enter New Password" required>
                        <input type="password" name="newpass2" class="validate" style="width:50%" placeholder="Retype Password" required>
                        <br>
                        <input type="submit" name="change_pass" value="SUBMIT" class="waves-effect waves-light log-in-btn"> 
                    </form>
                </div>
            </div>
        </div>
