            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li ><a href="_admin-goodmoral.php"> Good Moral</a>
                        </li>
                        <li class="active-bre"><a href="#"> Good Moral - Set Date</a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <form method="POST" action="process.php">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                ...
                                                <button class="btn waves-effect btn-success" name="goodmoral_resched"><strong>Submit</strong></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
