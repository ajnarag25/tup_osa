                    ...
                    <div class="marketing" style="text-align: center;">
                        ...
                        <div class="row text-center">
                            <div class="col-lg-4 com-sp">
                                <img class="materialboxed bd-placeholder-img rounded-circle" width="200" height="200" src="images/ami/11.jpg" role="img" aria-label="Placeholder: 130x130" preserveAspectRatio="xMidYMid slice" focusable="false">
                                <p style="font-size: large; padding-top: 10px;"><strong>Jane Doe</strong> </p>
                                <p><a class="btn btn-danger btn-waves" href="#votingform">Vote</a></p>
                            </div>
                            <div class="col-lg-4 com-sp">
                                <img class="materialboxed bd-placeholder-img rounded-circle" width="200" height="200" src="images/ami/8.jpg" role="img" aria-label="Placeholder: 130x130" preserveAspectRatio="xMidYMid slice" focusable="false">                       
                                <p style="font-size: large; padding-top: 10px;"><strong>Lancelot Gusion</strong></p>
                                <p><a class="btn btn-danger btn-waves" href="#votingform">Vote</a></p>
                            </div>
                            <!-- <div class="col-lg-4 com-sp">
                                <img class="materialboxed bd-placeholder-img rounded-circle" width="200" height="200" src="images/ami/9.jpg" role="img" aria-label="Placeholder: 130x130" preserveAspectRatio="xMidYMid slice" focusable="false">
                                <p>Bin Laden</p>
                                <a class="btn btn-danger btn-waves" href="#">Vote</a>
                            </div> -->

                            <!-- col-lg-6 kapag dalawa lang yung tatakbo na candidate tapos col-lg-4 kapag more than 3 yung tatakbong candidate -->
                        </div>
                ...
                <div id="votingform" class="com-sp pad-bot-20 ed-res-bg">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select id="limitsecretary" multiple="multiple" onchange="secretary()">
                                    <option disabled >-- Select two candidate--</option>
                                    <option value="Jane Doe">Jane Doe</option>
                                    <option value="Lancelot Gusion">Lancelot Gusion</option>	
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select id="limitsix1" multiple="multiple" onchange="six1()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select id="limitsix2" multiple="multiple" onchange="six2()">
                                    <option disabled >-- Select six candidate--</option>
                                    <option value="Jane Doe">Jane Doe</option>
                                    <option value="Lancelot Gusion">Lancelot Gusion</option>	
                                    <option value="Bin Laden">Bin Laden</option>	
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select id="limitsix3" multiple="multiple" onchange="six3()">
                                    <option disabled >-- Select six candidate--</option>
                                    <option value="Jane Doe">Jane Doe</option>
                                    <option value="Lancelot Gusion">Lancelot Gusion</option>	
                                    <option value="Bin Laden">Bin Laden</option>	
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select id="limitsix4" multiple="multiple" onchange="six4()">
                                    <option disabled >-- Select six candidate--</option>
                                    <option value="Jane Doe">Jane Doe</option>
                                    <option value="Lancelot Gusion">Lancelot Gusion</option>	
                                    <option value="Bin Laden">Bin Laden</option>	
                        ...
                        <div class="form-group mar-bot-0">
                            <div class="col-sm-offset-3 col-sm-9">
                                <i class="waves-effect waves-light light-btn waves-input-wrapper"><input type="submit" value="Submit" class="waves-button-input"></i>
                            </div>
                        </div>
                    </form>
                </div>
