...
<head>
    <title>TUPC OSA Services - OTP Verification</title>
    <!-- META TAGS -->
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="head-2-inn head-2-inn-padd-top">
                    <form class="s12" action="process.php" method="POST">
                        ...
                        <input type="number" name="otp" class="validate" style="width:50%" placeholder="ENTER OTP" required>
                        <br>
                        <input type="submit" name="otp_submit" value="SUBMIT" class="waves-effect waves-light log-in-btn"> 
                    </form>
                </div>
            </div>
        </div>
